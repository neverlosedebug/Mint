...
import net.mint.utils.inventory.kit.Kit;
import net.mint.utils.inventory.kit.KitManager;
import net.minecraft.item.ItemStack;
import net.minecraft.registry.Registries;
import net.minecraft.util.Identifier;
import net.mint.utils.inventory.kit.Kit.KitItem;
...
public class KitCommand extends Command {
    ...
    public void onCommand(String[] args) {
        if (args.length == 0) {
            ...
            Services.CHAT.sendRaw("§7.kit load <name> - Load a kit for Inventory use.");
        ...
        switch (action) {
            ...
            case "load":
                ...
                if (kitManager.loadKit(kitName)) {
                    Services.CHAT.sendRaw("§7Kit §s" + kitName + " §7loaded. Inventory is now using its requirements.");
                } else {
            ...
            case "unload":
                ...
                kitManager.setCurrentKit(null);
                Services.CHAT.sendRaw("§7Kit unloaded. Inventory is now using feature settings.");
                break;
