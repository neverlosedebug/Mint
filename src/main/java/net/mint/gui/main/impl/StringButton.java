    ...
    public void render(DrawContext context, int mouseX, int mouseY, float delta) {
        ...
        if (listening) {
            if (selecting) {
                ...
                String cursorChar = Mint.CLICK_GUI.isLine() ? "|" : " ";
        ...
        if (ctrl) {
            if (keyCode == GLFW.GLFW_KEY_V) {
                try {
                    ...
                    Mint.getLogger().error("{}: Failed to process clipboard paste", exception.getClass().getName(), exception);
                }
                return;
            }
            ...
            if (keyCode == GLFW.GLFW_KEY_C && selecting) {
                try {
                    ...
                    Mint.getLogger().error("{}: Failed to process clipboard change", exception.getClass().getName(), exception);
                }
                return;
            }
