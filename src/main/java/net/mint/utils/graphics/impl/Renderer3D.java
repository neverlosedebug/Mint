package net.mint.utils.graphics.impl;
...
import net.mint.utils.graphics.api.RenderGlobals;
import net.mint.utils.graphics.api.RenderLayers;
...
public class Renderer3D implements Globals
{
    ...
    public static final RenderLayer.MultiPhase QUADS_LAYER = RenderLayer.of(Mint.MOD_ID + "_quads",
            786432,
    ...
    public static final RenderLayer.MultiPhase DEBUG_LINES_LAYER = RenderLayer.of(Mint.MOD_ID + "_debug_lines",
            786432,
            RenderLayers.DEBUG_LINES_PIPELINE,
            RenderLayer.MultiPhaseParameters.builder().layering(RenderGlobals.LINE_SMOOTH_LAYERING).build(false));

    public static final Function<GpuTextureView, RenderLayer> GUI_TEXTURED_LAYER =
            Util.memoize(texture -> RenderLayer.of(Mint.MOD_ID + "_gui_font_textured",
                    786432, RenderPipelines.GUI_TEXTURED,
                    RenderLayer.MultiPhaseParameters.builder().layering(new RenderPhase.Layering(Mint.MOD_ID + "_gl_texture",
    ...
    public static final Function<GpuTextureView, RenderLayer> GUI_LAYER =
            Util.memoize(texture -> RenderLayer.of(Mint.MOD_ID + "_gui_layer",
