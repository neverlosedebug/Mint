package net.mint.utils.entity.player.socials;

import net.mint.Manager;
import net.mint.Mint;
import net.mint.Managers;
import net.mint.modules.impl.client.EngineFeature;
...
public class FriendManager extends Manager {
    ...
    private final String friendFile = Mint.NAME + "/client/friends.json";
    ...
    public void saveFriends() {
        try {
            FileUtils.createDirectory(Mint.NAME + "/client");
