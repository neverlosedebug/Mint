...
import net.mint.mixins.accessors.ClientPlayerInteractionManagerAccessor;
import net.mint.services.Service;
import net.mint.utils.Globals;
import net.mint.utils.inventory.switches.SearchLogic;
import net.mint.utils.inventory.switches.SwitchPriority;
import net.mint.utils.inventory.SwitchType;
import net.mint.utils.inventory.switches.types.HotbarSwitch;
import net.mint.utils.inventory.switches.types.InvSwitch;
import net.mint.utils.inventory.switches.types.SwapSwitch;
import net.mint.utils.inventory.switches.types.Switch;
...
import static net.mint.utils.inventory.SwitchType.*;
