...
public class FeatureManager extends Manager {
    private static final Reflections REFLECTIONS = new Reflections("net.mint.modules.impl");
    private final List<Feature> features = new ArrayList<>();
    private final Map<Class<? extends Feature>, Feature> featuresClasses = new Reference2ReferenceOpenHashMap<>();

    public FeatureManager() {
        super("Feature", "Allows you to register, or access every feature in " + Mint.NAME);
    }
    ...
    public void onInit() {
        ...
        for (Class<? extends Feature> clazz : set) {
            try {
                ...
                Mint.getLogger().error("Error while instantiating {}", clazz.getName(), e);
            }
        }
