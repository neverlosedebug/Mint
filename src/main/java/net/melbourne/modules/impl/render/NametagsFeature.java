...
public class NametagsFeature extends Feature {
    ...
    public void onRenderOverlay(RenderHudEvent event) {
        ...
        for (PlayerEntity player : mc.world.getPlayers()) {
            ...
            if (BotManager.INSTANCE != null && player != mc.player) {
                isMint = BotManager.INSTANCE.isMelbourneUser(uuid);
                if (isMint) {
            ...
            if (isMint && ("Symbol".equalsIgnoreCase(mode) || "Both".equalsIgnoreCase(mode))) {
    ...
    private Color getNameColor(PlayerEntity player) {
        ...
        if (BotManager.INSTANCE != null && BotManager.INSTANCE.isMelbourneUser(player.getUuid())) {
